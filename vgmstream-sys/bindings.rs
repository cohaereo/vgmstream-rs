...
pub const STREAMFILE_DEFAULT_BUFFER_SIZE: u32 = 32768;
...
extern "C" {
    pub fn put_8bit(buf: *mut u8, i: i8);
}
extern "C" {
    pub fn put_16bitLE(buf: *mut u8, i: i16);
}
extern "C" {
    pub fn put_32bitLE(buf: *mut u8, i: i32);
}
extern "C" {
    pub fn put_16bitBE(buf: *mut u8, i: i16);
}
extern "C" {
    pub fn put_32bitBE(buf: *mut u8, i: i32);
}
extern "C" {
    pub fn round10(val: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn align_size_to_block(value: usize, block_align: usize) -> usize;
}
...
fn bindgen_test_layout__finddata32_t() {
    const UNINIT: ::std::mem::MaybeUninit<_finddata32_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__finddata32i64_t() {
    const UNINIT: ::std::mem::MaybeUninit<_finddata32i64_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout__finddata64i32_t() {
    const UNINIT: ::std::mem::MaybeUninit<_finddata64i32_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout___finddata64_t() {
    const UNINIT: ::std::mem::MaybeUninit<__finddata64_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
pub struct _STREAMFILE {
    ...
    >,
    pub get_size: ::std::option::Option<unsafe extern "C" fn(sf: *mut _STREAMFILE) -> usize>,
    pub get_offset: ::std::option::Option<unsafe extern "C" fn(sf: *mut _STREAMFILE) -> offv_t>,
    ...
    >,
    pub close: ::std::option::Option<unsafe extern "C" fn(sf: *mut _STREAMFILE)>,
